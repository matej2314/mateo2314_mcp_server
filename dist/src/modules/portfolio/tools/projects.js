...
export function registerProjectsTools(server, options) {
    ...
    registerInstrumentedTool(server, moduleId, `${ns}_projects_query`, {
    ...
    registerInstrumentedTool(server, moduleId, `${ns}_projects_list`, {
    ...
    registerInstrumentedTool(server, moduleId, `${ns}_projects_get`, {
        description: `[${ns}] Szczegóły projektu po id (nazwa pliku bez .md)`,
        inputSchema: {
            id: z
                .string()
                .min(1)
                .describe("Identyfikator pliku, np. portfolio-nextjs"),
        },
    }, async (args) => {
    ...
    registerInstrumentedTool(server, moduleId, `${ns}_projects_tags`, {
